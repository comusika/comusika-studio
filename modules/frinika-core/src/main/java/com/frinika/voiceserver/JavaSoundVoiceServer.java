...
public class JavaSoundVoiceServer extends VoiceServer implements Runnable {
    ...
    public void configureAudioOutput(JFrame frame)
    {
        ...
        final JComboBox cb = new JComboBox(validMixerInfos);
        dialog.add(cb);
        ...
        final JCheckBox maxPriorityCheckBox = new JCheckBox(getMessage("voiceserver.javasound.max_priority"),maxPriority);
