...
public class FrinikaAudioSystem {
    ...
    private static void configureMultiplexed(MultiplexedJavaSoundAudioServer s) {
        ...
        if (selectedValue == null) {
            // Object
            selectedValue = JOptionPane.showInputDialog(null,
                    CurrentLocale.getMessage("setup.select_audio_input"), "input",
                    JOptionPane.INFORMATION_MESSAGE, null, a, a[0]);
     ...
     * sets a new mixer.
     *
     * @param mixer new client for the server
    ...
    static public IOAudioProcess audioOutputDialog(JFrame frame, String prompt)
        ...
        Object selectedValue = JOptionPane.showInputDialog(frame,
                CurrentLocale.getMessage("setup.select_audio_output"), prompt, JOptionPane.INFORMATION_MESSAGE,
                null, a, a[0]);
        if (selectedValue == null) {
            return null;
        }
    ...
    static public IOAudioProcess getDefaultOutput(JFrame frame) {
        if (defaultOut == null) {
            try {
                audioOutputDialog(frame, CurrentLocale.getMessage("setup.select_default_output"));
            } catch (Exception e) {
    ...
    static public IOAudioProcess audioInputDialog(JFrame frame, String prompt)
        ...
        Object selectedValue = JOptionPane.showInputDialog(frame,
                CurrentLocale.getMessage("setup.select_audio_input"), prompt, JOptionPane.INFORMATION_MESSAGE,
                null, a, a[0]);
     ...
     *
     * @param frames measured total round trip latency.
     */
