...
public class FrinikaFrame extends JFrame implements ProjectFrame {
	 ...
	 */
	private static Vector<FrinikaFrame> openProjectFrames = new Vector<FrinikaFrame>();
...
//------------
	...
	JMenu toolsMenu() {
		...
		submenu = new JMenu(
				getMessage(ScriptingAction.actionId));
	...
	public void tryQuit() {
		...
		while (openProjectFrames.size() > 1) {
			...
			FrinikaFrame frame = openProjectFrames.firstElement();
			if (frame == this)
