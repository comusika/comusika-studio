...
public class SplashDialog extends JDialog {
    ...
    public SplashDialog() {
        ...
        Icon frinika_light = new javax.swing.ImageIcon(SplashDialog.class.getResource("/frinika_light_gradient.png"));
        ...
        Icon frinika_cloud = new javax.swing.ImageIcon(SplashDialog.class.getResource("/frinika_score.png"));
        ...
        Icon frinika_overscan = new javax.swing.ImageIcon(SplashDialog.class.getResource("/frinika_overscan.png"));
        ...
        BufferedImage mask;
        try {
            mask = ImageIO.read(SplashDialog.class.getResource("/frinika_mask.png"));
        } catch (IOException e) {
            e.printStackTrace();
            return;
        }
