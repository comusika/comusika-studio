...
/**
 * Keeps track of changes in selections on MIDI events and switches on/off menu
 * items related t MIDI funcitons. Also provides a uniform interface for
 * subclasses of AbstractMidiAction to get the MIDI data to operate on. This
 * MidiSelection works as SelectionListener on both PartSelection and MultiEvent
 * selection. If one of these contains a MIDI event, MidiSelection will fire a
 * selectionChanged event to its listeners. MidiSelection "joins" PartSelection
 * and MultiEventSelection, and filters out non-Midi selections among those.
 *
 * @author Jens Gulden
 */
