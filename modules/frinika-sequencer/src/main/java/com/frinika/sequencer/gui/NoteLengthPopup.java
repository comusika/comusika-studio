...
public class NoteLengthPopup extends JPopupMenu implements ActionListener {
	...
	static Icon[] icons = { 
			 AbstractSequencerProjectContainer.getIconResource("note_1.png"),  // bar      (whole note)      [1]
			 AbstractSequencerProjectContainer.getIconResource("note_4.png"),  // 1   note (quarter note)    [1/4]
			 AbstractSequencerProjectContainer.getIconResource("note_8.png"),  // 1/2 note (eighth note)     [1/8]
			 AbstractSequencerProjectContainer.getIconResource("note_12.png"), // 1/3 note (triplet)         [1/12] [3-tuplet]
			 AbstractSequencerProjectContainer.getIconResource("note_16.png"), // 1/4 note (sixteenth note)  [1/16]
			 AbstractSequencerProjectContainer.getIconResource("note_24.png"), // 1/6 note (sixteenth triplet note)  [1/24]
			 AbstractSequencerProjectContainer.getIconResource("note_32.png"),  // 1/8 note (32th note)  [1/32]
                         AbstractSequencerProjectContainer.getIconResource("note_64.png"),  // 1/16 note (64th note)  [1/64]
                    };
