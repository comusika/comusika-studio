...
public class PartViewEditor extends ItemScrollPane {
	...
	public PartViewEditor(final ProjectFrame frame) {
		...
		final JButton new_button = new JButton(AbstractSequencerProjectContainer.getIconResource("new_track.gif"));
		...
		final JButton up_button = new JButton(AbstractSequencerProjectContainer.getIconResource("uparrow.gif"));
		...
		final JButton down_button = new JButton(AbstractSequencerProjectContainer.getIconResource("downarrow.gif"));
	...
	//	toolBar.add(new ToolbarSeperator());
		...
		JButton palette = new JButton(AbstractSequencerProjectContainer
