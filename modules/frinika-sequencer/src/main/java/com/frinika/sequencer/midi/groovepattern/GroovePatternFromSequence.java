 ...
 *
 * The midi data must at least contain one event every beat, otherwise its size
...
//        ProjectFrame newProjectFrame = new ProjectFrame(newProject);
    ...
    /**
     * Copies all note-events from the MidiPart to track 0, channel 0, starting
     * at offset 4 beats (offset to cleanly capture negative shifts of the very
     * first beat)
     *
     * @param part
    ...
    /**
     * Copies all note-events from seq to track 0, channel 0, starting at offset
     * 4 beats
     *
     * (Might fail if multiple tracks are imported and a track other than #0 has
     * an earlier note than track #0. However, this method is mainly intended
     * for loading internally saved grooved patterns.)
     *
     * @param part
     * @param sequence empty 1-track sequence to be filled
     */
