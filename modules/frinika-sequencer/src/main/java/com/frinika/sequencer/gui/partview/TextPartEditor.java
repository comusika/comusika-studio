 ...
 *
 * Basically, this displays an editable JTextArea with the same size, font and
 * color right 'above' the displayed text-part in the lane-view. When editing
 * stops (the user presses return or escape), the component gets removed again.
 *
 * @author Jens Gulden
 */
