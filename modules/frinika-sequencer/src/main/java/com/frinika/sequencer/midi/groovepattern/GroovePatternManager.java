...
/**
 * <<singleton>> Globally handles groove-patterns for the groove-quantization
 * feature.
 *
 * TODO Currently stores user-defined or imported patterns as .mid files in a
 * directory .frinika-groove-patterns/. This is very simple, persistent storage
 * of patterns should be configurable via user-options.
 *
...
public class GroovePatternManager {
     ...
     *
     * @param name
     * @return a groove pattern with the requested unique name, or null if ot
     * found
     */
