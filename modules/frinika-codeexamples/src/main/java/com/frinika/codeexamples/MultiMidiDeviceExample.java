 ...
 *
 * Note: Frinika softsynths will not coexist with the default Javasound
 * softsynth.
 *
...
public class MultiMidiDeviceExample {
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        /**
         * FIXME MidiDeviceHandle recv[]=MidiHub.getMidiOutHandles();
         * MidiDeviceHandle
         * r=(MidiDeviceHandle)JOptionPane.showInputDialog(null,"Select","midiout
         * device",JOptionPane.INFORMATION_MESSAGE,null,recv,recv[0]); final
         * MidiDevice externMidi = r.getMidiDevice(); externMidi.open();
         *
         * proj.getSequencer().addMidiOutDevice(externMidi); // Set up the track
         * to use the transmitter created
         * lane.getTrack().setMidiDevice(externMidi);
         *
         * // Start playing sequence (Uncomment the following line) //
         * proj.getSequencer().start();
         *
         * // Show the project frame (you can comment out this - if you only
         * want to play) new ProjectFrame(proj); END FIXME
         */
    }
}
